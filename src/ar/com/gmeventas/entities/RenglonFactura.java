...
public class RenglonFactura {
    ...
    public RenglonFactura(Long id, Integer itemNro, Producto producto, String descripcion, Double gravado, Double gravado10_5, Double gravado0, Double gravado27, Float cantidad, Double exento, Double noGravado, Double impuesto, Double descuento, Double iva, Double iva10_5, Double iva0, Double iva27, Double total, IvaVentas ivaVentas, Double sugerido, Double costoG, Double costoI, Boolean fabricacion) {
        this.id = id;
