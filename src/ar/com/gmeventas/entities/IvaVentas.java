...
public class IvaVentas {
    ...
    public IvaVentas(Long id, Date fecha, String letra, Integer numeroSucursal, Integer numeroFactura, Cliente cliente, Double gravado, Double gravado10_5, Double gravado0, Double gravado27, Double exento, Double noGravado, Double impuesto, Double iva, Double iva10_5, Double iva0, Double iva27, Double total, Double descuentoGlobal, Date fechaCae, Long cae, String letraReferencia, Integer numeroSucursalReferencia, Integer numeroFacturaReferencia, Integer tipoDoc) {
        this.id = id;
        this.fecha = fecha;
        this.letra = letra;
