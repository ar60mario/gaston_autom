 ...
 * @author Mario
 */
public class FacturaWebPanificadosFrame extends javax.swing.JFrame {
    ...
    private final DecimalFormat dfi = new DecimalFormat("#0.0");
     ...
     */
    public FacturaWebPanificadosFrame() {
        ...
        if (evt.getModifiers() == 16) {
            if (comboClientes.getSelectedIndex() > 0) {
                ...
                try {
                    ...
                    Logger.getLogger(FacturaWebPanificadosFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaWebPanificadosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaWebPanificadosFrame().setVisible(true);
            }
        });
    }
...
//        JOptionPane.showMessageDialog(this, "VER");
        ...
        cnf.setUltimaFechaPanificados(fecha);
        try {
...
//        vencimientoFacturaPapel = sdf.format(fechaVto);
        ...
        if (categoriaIva != 1) {
            ...
            nombresColumnaFacturaPapel = "  IT CANT                   DETALLE                    P.UNIT.   GRAVADO      IVA       % IVA     TOTAL     SUG";
...
// Impuesto
                    //
                    Float fl;
                    String cd = tablaFactura.getValueAt(r, 0).toString();
                    Integer cod1 = Integer.valueOf(cd);
                    Producto pr1 = null;
                    try {
                        pr1 = new ProductoService().getProductoPanificadoByCodigo(cod1);
                    } catch (Exception ex) {
                        Logger.getLogger(FacturaWebPanificadosFrame.class.getName()).log(Level.SEVERE, null, ex);
                        System.exit(0);
                    }
                    ...
                    Float po1 = 0F;
                    if(pr1 != null){
                        po1 = pr1.getAlicuotaIva().getAlicuota();
                    }
                    str0 = dfi.format(po1);
                    str0 = str0.replace(",", ".");
                    fl = Float.valueOf(str0);
                    largo = fl.intValue();
                    espacio = "       ";
                    largo = String.valueOf(largo).length();
                    espacio = espacio.substring(largo);
                    renglones[r] = renglones[r] + espacio + dfi.format(fl) + " ";
//                    System.out.println(po1);
//                    System.out.println(cd);
//                    System.out.println(cod1);
//                    System.out.println(pr1);
//                    System.out.println(pr1.getDetalle());
//                    System.out.println(pr1.getAlicuotaIva().getAlicuota());
...
//            }
    ...
    class MyPrintable implements Printable {
        ...
        public int print(Graphics g, PageFormat pf, int pageIndex) {
            ...
            if (categoriaIva == 1) {
//                                           x                 x                      x                
                g2.drawString("SUBTOTAL      IVA 10.5%         IVA 21%              IVA 27%"
                        + "                                 TOTAL", 70, row);
            } else {
