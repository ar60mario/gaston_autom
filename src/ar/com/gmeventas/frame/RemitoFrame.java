 ...
 * @author Mario
 */
public class RemitoFrame extends javax.swing.JFrame {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(548, 637, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
        ...
        if (evt.getModifiers() == 16) {
            if (comboClientes.getSelectedIndex() > 0) {
                ...
                try {
                    ...
                    Logger.getLogger(RemitoFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemitoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemitoFrame().setVisible(true);
            }
        });
    }
