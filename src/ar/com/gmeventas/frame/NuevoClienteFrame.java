...
//        formaDePagoTxt.setText("1");
    ...
    private boolean validarCampos() {
        ...
        if(localidadTxT.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Cliente - Complete la LOCALIDAD");
            localidadTxT.requestFocus();
            return false;
        }
        if(codigoPostalTxt.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Cliente - Complete el CODIGO POSTAL");
            codigoPostalTxt.requestFocus();
            return false;
        }
        if(provinciaTxt.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Cliente - Complete la PROVINCIA");
    ...
    private void llenarCombos() {
        ...
        Cliente c = null;
        try {
            c = new ClienteService().getUltimoCliente();
        } catch (Exception ex) {
            Logger.getLogger(NuevoClienteFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        codig0 = Integer.valueOf(c.getCodigo());
        codig0 += 1;
        String cc = String.valueOf(codig0);
        codigoTxt.setText(cc);
    }
