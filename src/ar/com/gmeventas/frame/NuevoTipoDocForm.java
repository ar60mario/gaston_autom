 ...
 * @author Mario
 */
public class NuevoTipoDocForm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoTipoDocForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoTipoDocForm().setVisible(true);
            }
        });
    }
    ...
    private void grabar() {
        if (verificar()) {
            ...
            td.setCodigo(codigoTxt.getText());
            td.setDescripcion(descripcionTxt.getText());
            try {
                new TipoDocService().saveTipoDoc(td);
                JOptionPane.showMessageDialog(this, "Tipo Documento Guardado correctamente");
            } catch (Exception ex) {
                Logger.getLogger(NuevoTipoDocForm.class.getName()).log(Level.SEVERE, null, ex);
